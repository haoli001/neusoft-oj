...
<p class="navbar-left navbar-nav"><img id=logo src="<?php echo "template/".$OJ_TEMPLATE?>/image/logo.png">
</p>
...
<p class="navbar-text navbar-right"><script src="include/profile.php?<?php echo rand();?>" ></script>
</p>
		<?php }?>
	  </ul>
	</nav><!--end menu-->
