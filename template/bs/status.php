...
<div class="form-group">
    <label for="problem_id"><?php echo $MSG_PROBLEM_ID?>:</label>
    <input class="form-control" style="height:24px" type=text size=4 name=problem_id value='<?php echo $problem_id?>'>
  </div>
<div class="form-group">
    <label for="user_id"><?php echo $MSG_USER?>:</label>
    <input class="form-control" style="height:24px" type=text size=4 name=user_id value='<?php echo $user_id?>'>
  </div><?php if (isset($cid)) echo "<input type='hidden' name='cid' value='$cid'>";?>
  <div class="form-group">
    <label for="language"><?php echo $MSG_LANG?>:</label>
    <select class="input-small" size="1" name="language">
  ...
  <div class="form-group">
    ...
    <select class="input-mini" size="1" name="jresult">
...
echo "<button type=\"submit\" class=\"btn btn-default btn-sm\">$MSG_SEARCH</button>";
?>
</div>
</div>
<div id=center>
<table border="0"id=result-tab class="table table-striped table-hover"  align="center" width=80%>
<thead>
<tr >
<th align=center>
<?php echo $MSG_RUNID?>
