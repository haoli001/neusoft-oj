...
<center>
<table class="table table-striped table-bordered" id=statics width=70%>
<caption>
...
<?php
 if(isset($_SESSION['administrator'])){
	 ...
	 ?><table class="table table-striped table-bordered"><tr class=toprow><td>UserID<td>Password<td>IP<td>Time</tr>
	 <tbody>
			<?php 
			$cnt=0;
